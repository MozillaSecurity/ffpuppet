...
class Profile:
    ...
    def _copy_extensions(self, extension: str) -> None:
        assert self.path
        if isinstance(extension, (list, tuple)):
            extensions = [Path(x) for x in extension]
        else:
